...
async function fetchProjectsAPI() {
  ...
  return [
    ...
    // add some filler rows so pagination is visible
    ...Array.from({ length: 28 }).map((_, i) => ({
      id: `px${i + 4}`,
      name: `Project ${i + 4}`,
      client: i % 2 ? "Internal" : "External",
      status: ["Planned","In Progress","On Hold","Live","Completed","Cancelled"][i % 6],
      startDate: "",
      endDate: "",
      budget: (i % 3 === 0 ? "" : String((i + 1) * 100000)),
      description: "",
    })),
  ];
}
    ...
    <div className="h-full w-full">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold">Properties</h1>
          <p className="text-sm text-gray-500">Manage your Properties and create new ones.</p>
        </div>
